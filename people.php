...
<!-- CURRENT Ugrad -->
    <A onmouseover="swap('webImages/people.jpg');changetext('Samsara Counts, George Washington University, Class of 2019')" href="http://samsaranc.com">
    Samsara Counts</A><BR>
...
changetext('Joseph O\'Sullivan, Washington University, Class of 2016')">Joseph O'Sullivan</a><br>
   <A onmouseover="swap('webImages/people.jpg');
changetext('Morgan Redding, Washington University, Class of 2017')">Morgan Redding</a><br>
   ...
   <A onmouseover="swap('webImages/people.jpg');
changetext('Micah Goodman, Washington University, Class of 2017')">Micah Goodman</a><br>
   <A onmouseover="swap('webImages/people.jpg');
changetext('Ali Bukys, Washington University, Class of 2016')">Ali Bukys</a><br>
   ...
   <A onmouseover="swap('webImages/hawley.jpg');
changetext('Chris Hawley, Washington University, Class of 2013 (Dec.), now at Amazon/A9')">Christopher Hawley</a><br>
   <A onmouseover="swap('webImages/people.jpg');
changetext('Calvin Murdock, Washington University, Class of 2013, now PhD student at CMU')">Calvin Murdock</a><br>
   <A onmouseover="swap('webImages/people.jpg');
changetext('Vishnu Halthore, Washington University, Class of 2013')">Vishnu Halthore</a><br>
   <A onmouseover="swap('webImages/people.jpg');
changetext('Shane Carr, Washington University, Class of 2015')">Shane Carr</a><br>
   <A onmouseover="swap('webImages/people.jpg');
changetext('Brittany Shannon, Monmouth University, Class of 2013')
">Brittany Shannon</a><br>

   <A onmouseover="swap('webImages/tyler.jpg');
changetext('Tyler Trussel, Washington University, Class of 2012')">Tyler Trussel</a><br>

    <A onmouseover="swap('webImages/emilyFeder.jpeg');
changetext('Emily Feder, Washington University, Class of 2012, Currently in Chicago at Inspiration Corporation')
">Emily Feder</a><br>

    <A href="http://www.facebook.com/walkerburgin" 
onmouseover="swap('webImages/walker.jpeg');
changetext('Walker Burgin, Washington University, 2011, now at Microsoft')">
Walker Burgin</a><br>

    <A onmouseover="swap('webImages/people.jpg');
changetext('Nicholas Fridrich, Washington University (2011)')">Nicholas Fridrich</a><br>

    <A onmouseover="swap('webImages/people.jpg');
changetext('Brian Bies, Washington University (2010)')">Brian Bies</a><br>

    <A onmouseover="swap('webImages/nroman.jpg');changetext('Nathaniel Roman, Washington University (2010), Engineer at Facebook, now at Less Annoying CRM')" href="http://www.facebook.com/nroman">Nathaniel Roman</A><br>

    <A onmouseover="swap('webImages/jonathan.jpg');changetext('Jonathan Cannon, Brown University (2009), Completed a PhD at Boston University in Neuroscience')">Jonathan Cannon</a><br>
...
href="https://pbs.twimg.com/profile_images/3021776457/b2b13c335c190f0fb95c74669eaca7ff.jpeg"> 
    Eileen Duffner</A><br>
    ...
    <A onmouseover="swap('webImages/people.jpg');changetext('Agata Kargol, MS, 2015.')"> 
    Agata Kargol</A><br>
    <A onmouseover="swap('webImages/people.jpg');changetext('Adina Stoica, MS, 2014, Now a software Engineer at Cerner')"> 
    Adina Stoica</A><br>
    ...
    <A onmouseover="swap('webImages/joe.jpg');changetext('Joe Israelevitz')"> Joe Israelevitz</a><br>
    ...
    <A onmouseover="swap('webImages/satkin.jpg');changetext('Scott Satkin, BS 2006, MS 2008.  Now in PhD program at Carnegie-Mellon')"
href="http://research.satkin.com/">Scott Satkin</a><br>
    <A onmouseover="swap('webImages/garnett.jpg');changetext('Roman
    Garnett, BS/MS 2004, PhD Oxford, 2010.  Now Faculty at Washington University')"> Roman Garnett</a><br>
    <A onmouseover="swap('webImages/jurgens.jpg');changetext('David Jurgens, BS/MS 2004.  Now PhD student and power-lifting coach at UCLA')"
href="http://www.cs.ucla.edu/~jurgens">David Jurgens</a><br>    
...
href="https://www.linkedin.com/pub/zachary-freudenburg/6a/a92/993"> 
    ...
    <A onmouseover="swap('webImages/tucek.jpg');changetext('Jim Tucek, staff scientist until 2010-2012, worked at Reflektion, now at Nest Labs')"
 href="https://www.linkedin.com/pub/jim-tucek/53/82b/a72"> 
    Jim Tucek</A><br>

    <A onmouseover="swap('webImages/dixon.jpg');changetext('Michael Dixon, BS/MS 2003, staff scientist until 2011, worked at Willow Garage, then Reflektion, now at Nest Labs')" href="http://www.cs.wustl.edu/~msd2/">Michael Dixon</A><br>
    <A onmouseover="swap('webImages/manfred.jpg');
changetext('Manfred Georg, PhD 2010, now at Google')"   
    href="http://www.cse.wustl.edu/~mgeorg/index.html">Manfred
    Georg, PhD</A><br>
    <A onmouseover="swap('webImages/nathan_jacobs.jpg');
changetext('Nathan Jacobs, PhD 2010, now Assistant Professor at University of Kentucky')"
    href="http://cs.uky.edu/~jacobs/">Nathan Jacobs, PhD</A><br>
    <A onmouseover="swap('webImages/richard.jpg');
changetext('Richard Souvenir, PhD 2006, now Associate Professor at University of North Carolina - Charlotte')"
    href="http://www.cs.uncc.edu/~souvenir/">Richard Souvenir, PhD</A><br>
    <A onmouseover="swap('webImages/qilong.jpg');
changetext('Qilong Zhang, PhD 2006, now at Nomura')"
    href="http://www.cs.wustl.edu/~zql">Qilong Zhang, PhD</A><br>
</i>
<br><br>
    </TD>
    </TR>
